...
agency_dialog = Dialog(
    ...
    Window(
        ...
        Button(Const(text=_('ADD_MANAGER_BUTTON')), id='add_manager',
               on_click=AgencyManagerCallbackHandler.add_user),
        Button(Const(text=_('FULL_BLOGERS_LIST_BUTTON')), id='blogers_list',
        ...
        SwitchTo(Const(text='Отчет по работе агентства'), id='agency_income', state=AgencyStateGroup.input_period),
