...
manager_dialog = Dialog(
    ...
    Window(
        ...
        Button(Const(text=_('ADD_BLOGER')), id='manager_add_bloger', on_click=CallBackHandler.add_user),   # TODO: !!!!!!!!!!!!!!!
        Button(Const(text=_('BLOGERS_LIST')), id='manager_blogers_list', on_click=CallBackHandler.list_of_users),   # TODO: !!!!!!!!!!!!!!!
    ...
    Window(
        ...
        # Button(Const(text=_('DELETE')), id='delete_user', on_click=CallBackHandler.delete_user),
    ...
    Window(
        ...
        MessageInput(
            func=CallBackHandler.entered_task,
    ...
    Window(
        Const(text=_('PICK_ACTION')),
        Button(Const(text=_('ASK_STATS')), id='ask_stats', on_click=CallBackHandler.ask_stats_from_user),
        Button(Const(text=_('CHECK_STATS')), id='check_stats', on_click=CallBackHandler.check_stats),
        SwitchTo(Const(text=_('BACK_BUTTON')), id='go_to_user_menu', state=ManagerStateGroup.user_menu),
